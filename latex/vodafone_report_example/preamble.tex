...
\usepackage[left=70mm,right=20mm,top=20mm,bottom=20mm, heightrounded, marginparwidth=60mm, marginparsep=5mm]{geometry} % Use nice margins. Does give a small change in the default page margins. 
...
\fancyhead[RE]{%
	\begin{adjustbox}{left, minipage=0.8\paperwidth}\begin{tikzpicture}
		...
		\fill[yellow!50,path fading=west] (0.7\linewidth,3em) rectangle (\linewidth,1.5em);
...
\fancyhead[LO]{%
	...
	\fill[yellow!50,path fading=east] (0,3em) rectangle (0.3\linewidth,1.5em);
	\end{tikzpicture}\end{adjustbox}}
\newcommand{\textoverline}[1]{$\overline{\mbox{#1}}$}
\fancyfoot[LE]{\begin{adjustbox}{left, minipage=\paperwidth}
		\raggedright
		\textoverline{\underline{\hphantom{\ }\thepage
				\begin{minipage}[c]{0\linewidth}
					\rule{0pt}{2.5ex}
				\end{minipage}
				\rule{0.8\linewidth}{0pt}\rule{0pt}{2.0ex}}}
	\end{adjustbox}
}
\fancyfoot[RO]{\begin{adjustbox}{right, minipage=\paperwidth}
		\raggedleft
	\textoverline{\underline{
			\begin{minipage}[c]{0\linewidth}
				\rule{0pt}{2.5ex}
			\end{minipage}
			\rule{0.8\linewidth}{0pt}\rule{0pt}{2.0ex}\thepage\hphantom{\ }}}
	\end{adjustbox}
	}
...
{\color{oxfordblue}\thesection}{1em}{\thesection.\quad}
