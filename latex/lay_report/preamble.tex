...
\newcommand{\infommmarginnote}[2][0mm]{\leavevmode\marginnote{\large\sffamily{}\sansmath\begin{mysidenote}{#2}\end{mysidenote}}[{#1}]\ignorespaces}
...
\NewDocumentEnvironment{infommitemize}{}{% verticle offset
    \noindent
    \begin{itemize}[label={\color{oxfordblue}{$\blacksquare$}}]
    }
    {%
    \end{itemize}
}
...
\newcommand{\companylogo}[1][cover_image]{
    \newcommand{\thecompanylogo}{#1}
}
