...
\usepackage{xcolor} % Nice colours for shading. 
...
\usepackage[margin=10pt,font=small,labelfont=bf,labelsep=endash]{caption} % Caption figures and tables nicely. %% After cleveref.
...
\newcommand{\infommmarginnote}[2][0mm]{\marginnote{\begin{mysidenote}{#2}\end{mysidenote}}[{#1}]}
