...
\node[anchor=north west, xshift=10mm, yshift=-10mm] at (current page.north west) {\includegraphics[width=0.35\linewidth]{epsrc_logo_new}};
...
\node[anchor=south east, xshift=-11mm, yshift=11mm] at (current page.south east) {\includegraphics[width=0.4\linewidth]{\thecompanylogo}};
\end{tikzpicture}
