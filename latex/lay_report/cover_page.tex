...
\node[anchor=south east, xshift=-10mm, yshift=10mm] at (current page.south east) {\includegraphics[width=0.3\linewidth]{arm_logo_blue}};
\end{tikzpicture}

\begin{center}

\Huge{\textbf{EPSRC Centre for Doctoral Training in Industrially Focused Mathematical Modelling}}
\vfill
\begin{figure}[h]
\centering
...
\end{figure}
\vfill
\Huge{\textbf{A Kick-ass lay report}}\\
\vspace{0.02\paperheight}
\Large{\textbf{Oliver Sheridan-Methven}}
\vspace{0.02\paperheight}
\end{center}
\restoregeometry
}
