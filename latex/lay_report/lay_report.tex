...
\lipsum[75] It's all about \marginnote{
	\begin{center}
		...
		\end{tabular}
	\end{center}
	\captionof{table}{Some physical constants which frequently come in hadny for calculations, although being InFoMM we would always non-dimensionalise.}
}
\begin{equation}
...
\infommmarginnote[10mm]{I love these new side bubbles! They're awesome and very helpful.
